...
PROTOCOL_COMPATIBILITY = {
    "1.0": ProtocolVersionRange(min_version="1.0", max_version="1.1", fallback_versions=["1.0"]),
    "1.1": ProtocolVersionRange(min_version="1.0", max_version="1.1", fallback_versions=["1.0", "1.1"]),
}
...
REQUIRED_CAPABILITIES = {
    "1.0": {"basic": ["send_message", "receive_message"], "streaming": ["stream_data"], "async": ["async_operation"]},
    "1.1": {
