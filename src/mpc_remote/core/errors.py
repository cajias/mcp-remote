...
class ConsentError(MCPError):
    ...
    def __init__(self, resource_name: str) -> None:
        super().__init__(f"Consent required for '{resource_name}'", code=MCPErrorCode.CONSENT_REQUIRED)
...
class ValidationError(MCPError):
    ...
    def __init__(self, message: str, details: Optional[dict] = None) -> None:
        super().__init__(message, code=MCPErrorCode.VALIDATION_ERROR, details=details)
...
class ConnectionError(MCPError):
    ...
    def __init__(self, message: str) -> None:
        super().__init__(message, code=MCPErrorCode.CONNECTION_ERROR)
...
class AuthenticationError(MCPError):
    ...
    def __init__(self, message: str = "Authentication failed") -> None:
        super().__init__(message, code=MCPErrorCode.AUTHENTICATION_ERROR)
